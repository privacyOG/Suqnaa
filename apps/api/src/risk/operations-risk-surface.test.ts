...
assert.match(identityReconciliation, /identityHash: hashCorrelation\('verification_subject', `\$\{check\.provider\}:\$\{check\.reference\}`\)/);
assert.match(identityReconciliation, /identityHash: hashCorrelation\('payout_account', `\$\{account\.provider\}:\$\{account\.provider_account_reference\}`\)/);
assert.doesNotMatch(identityReconciliation, /identityHash:\s*check\.reference\b/);
assert.doesNotMatch(identityReconciliation, /identityHash:\s*account\.provider_account_reference\b/);
