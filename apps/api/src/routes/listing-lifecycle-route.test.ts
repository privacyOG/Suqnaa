...
assert.match(routeSource, /app\.get\('\/listings\/:listingId\/lifecycle'/);
assert.match(routeSource, /app\.post\('\/listings\/:listingId\/renew'/);
assert.match(routeSource, /preHandler: requireUser/);
assert.match(routeSource, /readSellerListingLifecycle/);
