...
const routePermissions: readonly {
  ...
  { method: 'GET', pattern: /^\/v1\/operations\/dashboard\/fraud(?:\?.*)?$/, permission: 'risk.read' },
  { method: 'GET', pattern: /^\/v1\/operations\/risk\/rules(?:\?.*)?$/, permission: 'risk.read' },
  { method: 'POST', pattern: /^\/v1\/operations\/risk\/rules(?:\?.*)?$/, permission: 'risk.manage' },
