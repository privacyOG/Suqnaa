...
assert.match(secretContract, /mode `0700`/i);
assert.match(secretContract, /mode `0644`/i);
assert.match(rotateScript, /chmod 0700 "\$secret_dir"/);
assert.match(rotateScript, /install -m 0644/);
